...
public class NativeDialogViewNew
        extends RelativeLayout
{
    ...
    public NativeDialogViewNew(Context context, boolean isInstall)
    {
        super(context);
    ...
    public NativeDialogViewNew(Context context, AttributeSet attr)
    {
        super(context, attr);
        this.context = context;
        init(attr);
    ...
    {
        mRoot = LayoutInflater.from(getContext()).inflate(R.layout.activity_native_advance_text_img_640_320, this);
        closeLayout=mRoot.findViewById(R.id.close_iv);
        tvTitle=mRoot.findViewById(R.id.title_tv);
