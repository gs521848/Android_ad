...
public class SplashActivity extends Activity {
    ...
    private SplashView.SplashAdLoadListener splashAdLoadListener = new SplashView.SplashAdLoadListener() {
        ...
        public void onAdDismissed() {
            ...
            //Toast.makeText(com.huawei.hms.ads.sdk.SplashActivity.this, getString(R.string.status_ad_dismissed), Toast.LENGTH_SHORT).show();
            jump();
        }
    };
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ImageView ivApp=findViewById(R.id.iv_appicon);
        ivApp.setImageResource(getResources().getIdentifier("app_icon","mipmap",getPackageName()));
        TextView tvAppname=findViewById(R.id.tv_owner);
        tvAppname.setText(getResources().getIdentifier("app_name","string",getPackageName()));
    ...
    private void loadAd() {
        ...
        splashView.setSloganResId(R.drawable.splash_loading);
        //splashView.setLogo(findViewById(R.id.logo_area));

        // Set a logo image.
        splashView.setLogoResId(getResources().getIdentifier("app_icon","mipmap",getPackageName()));
        // Set logo description.
        splashView.setMediaNameResId(R.string.media_name);
        // Set the audio focus type for a video splash ad.
        splashView.setAudioFocusType(AudioFocusType.NOT_GAIN_AUDIO_FOCUS_WHEN_MUTE);

        splashView.load(Comm.AD_SPLASH_AD, ActivityInfo.SCREEN_ORIENTATION_PORTRAIT, adParam, splashAdLoadListener);
